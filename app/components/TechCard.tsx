...
const TechCard = ({
  ...
  <div className="flex min-h-[100px] items-center gap-5 rounded-xl border border-[#33a3f4] bg-[#FAFAFA] p-2.5 transition-colors duration-200 hover:border-[#689ec4] hover:bg-[#F4F4F7]/90">
        ...
        {techStack.map(item => (
          ...
          >
            <Image
              ...
              height={1000}
              alt={`${item.name} logo`}
              className={`size-8 ${item.name === 'NextJS' ? '' : ''} transition-transform duration-200 hover:scale-110`}
            />
