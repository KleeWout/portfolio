...
const Skills = () => {
  ...
  return (
    <div
      ref={ref}
      className="text-text-main relative z-10 mx-auto min-h-screen max-w-[80rem] px-6 py-16 sm:px-8 sm:py-24 md:px-12 lg:px-16"
      id="about"
    >
      <div className="mx-2 mb-10 w-fit space-y-4 sm:mx-4 md:mx-6 lg:mx-8">
        <motion.h1
          ...
          className="text-3xl font-bold min-[430px]:text-4xl md:text-5xl"
        >
          My Current Skills
        </motion.h1>
        <motion.p
          ...
          variants={headerLeftVariants}
          transition={{ duration: 0.5, delay: 0.25 }}
          className="max-w-lg text-sm min-[430px]:text-base md:max-w-3xl"
        >
