...
export default function Header() {
  ...
  return (
    <header
      className={`text-text-main fixed top-0 right-0 left-0 z-50 border-b border-gray-200 bg-[#f8f6f4]/98 transition-transform duration-300 ease-in-out ${
    ...
    >
      <div className="mx-auto max-w-7xl px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          >
            <svg
              ...
              fill="currentColor"
              className="text-main h-8 w-auto"
            >
        ...
        {/* Mobile Menu */}
        <div
          className={`overflow-hidden border-t border-gray-200 bg-[#f8f6f4]/98 transition-all duration-300 ease-in-out md:hidden ${
